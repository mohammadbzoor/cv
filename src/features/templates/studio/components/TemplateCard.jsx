    ...
    >
      <div className="space-y-3">
        ...
        <div
          lang="en"
          dir="ltr"
          className="cursor-pointer overflow-hidden rounded-xl border border-border/40 group bg-app-bg p-2 flex justify-center items-center h-48 sm:h-52 relative"
